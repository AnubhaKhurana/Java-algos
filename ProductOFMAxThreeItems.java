...
public class ProductOFMAxThreeItems {

	  // Add any helper functions you may need here
		  void removeSmallestNumberAndReturnThreeBiggestNumbers(TreeSet<Integer> setObj, int ithNumber){
		    setObj.add(ithNumber);
	        if(setObj.size() > 3)
		      setObj.pollFirst();
		  }
	  ...
	  int[] findMaxProduct(int[] arr) {
	    // Write your code here
		    ...
		    for(int i=2; i<sizeOfArray; i++){
		      removeSmallestNumberAndReturnThreeBiggestNumbers(setObj, arr[i]);
		      int product = 1;
	  ...
	  public static void main(String[] args) {
	    new ProductOFMAxThreeItems().run();
	  }
}
